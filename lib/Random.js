...
//}@dev
    ...
    this._ = new Uint32Array(BUFFER_END); // buffer. 4byte * 64 = 256bytes
...
//  this._[4] = 0; // BUFFER START POINT
//         :
//  this._[64] = 0; // BUFFER END POINT

    _fillValue(this._, BUFFER_START, BUFFER_END);
